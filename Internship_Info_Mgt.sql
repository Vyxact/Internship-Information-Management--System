...
--
-- Host: localhost
-- Generation Time: Mar 27, 2022 at 01:11 PM
...
--
-- Table structure for table `apply_internship_post`
--

CREATE TABLE `apply_internship_post` (
  `id_apply` int(11) NOT NULL,
  `id_internshippost` int(11) NOT NULL,
...
--
-- Dumping data for table `apply_internship_post`
--

INSERT INTO `apply_internship_post` (`id_apply`, `id_internshippost`, `id_company`, `id_student`, `status`) VALUES
(1, 1, 1, 1, 0),
(2, 2, 1, 1, 0),
(3, 3, 4, 1, 0),
(4, 4, 1, 1, 0),
...
INSERT INTO `company` (`id_company`, `name`, `companyname`, `country`, `province`, `city`, `contactno`, `website`, `email`, `password`, `aboutme`, `logo`, `createdAt`, `active`) VALUES
(1, 'WE IT', 'WD IT', 'Bangladesh', 'Dhaka', 'Dhaka', '1234567890', 'www.wdit.net', 'shihab15-4975@diu.edu.bd', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'Develop Web base application, develop Android  and also iOS ', '5ac8f8384ee59.png', '2018-04-07 08:56:24', 1),
(2, 'AS IT', 'AS IT', 'Bangladesh', 'Nawabganj', 'Nawabganj', '1234567890', 'www.asit.net', 'shihab.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'We develop Wordpress theme', '5ac923c0d7a89.png', '2018-04-07 12:02:08', 2),
(3, 'DF IT', 'DF IT', 'Bangladesh', 'Dhaka', 'Dhaka', '1234567890', 'www.dfit.net', 'shamim.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'We develop Wordpress theme', '5ac924a186b76.png', '2018-04-07 12:05:53', 1),
(4, 'ZC IT', 'ZX IT', 'Uganda', 'Central', 'Bombo', '1234567890', 'www.zxit.net', 'noor.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'Front End developer ', '5ac92601791e0.png', '2018-04-07 12:11:45', 1),
(18, '151289', 'Test Company 2', 'Bangladesh', 'Dhaka', 'Dhaka', '3464257856', 'www.testcompany2.com', 'testcompany2@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'bgfdhfd', '5f612966d6426.jpg', '2020-09-15 12:51:50', 1);
...
--
-- Table structure for table `internship_post`
--
...
CREATE TABLE `internship_post` (
  ...
  `knowledgeexperience` varchar(255) NOT NULL,
  `major` varchar(255) NOT NULL,
  `createdat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `internship_post`
--

INSERT INTO `internship_post` (`id_internshippost`, `id_company`, `internshiptitle`, `description`, `minimumsalary`, `maximumsalary`, `knowledgeexperience`, `major`, `createdat`) VALUES
(1, 1, 'App Developer ', '<p>We Hire Android App developer</p>', '20000', '30000', '1', 'Bsc in CSE/IT/SWE', '2018-04-07 10:33:14'),
(2, 1, 'Android App developer', '<p>We hire android app developer</p>', '20000', '30000', '1', 'Bsc in CSE/IT/SWE', '2018-04-07 11:58:58'),
(3, 1, 'Front End Developer Need', '<p>Front End Developer Need</p>', '15000', '20000', '4', 'Bsc in CSE/IT/SWE', '2018-04-07 12:12:53'),
(4, 4, ' Graphic designer', '<p>we are looking for a graphic designer</p>', '15000', '20000', '5', 'Bsc in CSE/IT/SWE', '2018-04-07 12:14:19'),
(5, 1, ' wordpress theme developer', '<p>we are looking for a wordpress theme developer</p>', '40000', '30000', '3', 'Bsc in CSE/IT/SWE', '2018-04-07 12:18:24'),
(6, 4, 'App Developer ', '<p>we are looking for a App Developer&nbsp;</p>', '20000', '15000', '4', 'Bsc in CSE/IT/SWE', '2018-04-07 12:25:07'),
(20, 18, 'Arc Development', '<p>dfghdfshdfgh</p>', '1000', '64564', '2', 'Graduate', '2020-09-15 12:53:19');
...
(1, 18, 'user', 0, 'Test Mail', '<p>dfgdfgdfg</p>', '2020-09-15 10:33:12'),
(1, 18, 'user', 0, 'Test Mail', '<p>dfgdfgdfg</p>', '2020-09-15 10:33:12'),
(1, 18, 'user', 0, 'Test Mail', '<p>dfgdfgdfg</p>', '2020-09-15 10:33:12'),
(1, 18, 'user', 0, 'Test Mail', '<p>dfgdfgdfg</p>', '2020-09-15 10:33:12'),
(1, 18, 'user', 0, 'Test Mail', '<p>dfgdfgdfg</p>', '2020-09-15 10:33:12'),
...
INSERT INTO `reply_mailbox` (`id_reply`, `id_mailbox`, `id_student`, `usertype`, `message`, `createdAt`) VALUES
(1, 1, 18, 'company', '<p>cfbcvbcvbcvb</p>', '2020-09-15 13:04:17'),
(1, 1, 18, 'company', '<p>cfbcvbcvbcvb</p>', '2020-09-15 13:04:17'),
(1, 1, 18, 'company', '<p>cfbcvbcvbcvb</p>', '2020-09-15 13:04:17'),
(1, 1, 18, 'company', '<p>cfbcvbcvbcvb</p>', '2020-09-15 13:04:17'),
(1, 1, 18, 'company', '<p>cfbcvbcvbcvb</p>', '2020-09-15 13:04:17'),
...
INSERT INTO `students` (`id_student`, `firstname`, `lastname`, `email`, `password`, `university`, `city`, `province`, `contactno`, `major`, `stream`, `passingyear`, `dob`, `age`, `post`, `resume`, `hash`, `active`, `aboutme`, `skills`) VALUES
(2, 'Md', 'Shihab', 'shihab.user@gmail.com', 'OTU3MzljOGIyNGZjMGViN2FkNWIyMTQ3ZjAyOWFlY2Y=', 'Rajshahi', 'Chapai', 'Chapai', '1234567890', 'Bsc in CSE/IT/SWE', '', '2018-04-02', '1960-01-01', '58', '', '5ac920fc43d1b.pdf', '6971eb3debbeb7631ec729326122ceea', 1, 'Student', 'Java, Android'),
(3, 'Md', 'Shamim', 'shamim.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'Rajshahi', 'Chapai', 'Chapai', '1234567890', 'Bsc in CSE/IT/SWE', '', '2018-04-02', '1960-01-01', '58', '', '5ac9213e843e1.pdf', 'c1ffbc969a2a3ec8ea10c5e3091834ca', 0, 'Student', 'Java, Android'),
(4, 'Md', 'Noor', 'noor.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'Rajshahi', 'Chapai', 'Chapai', '1234567890', 'Bsc in CSE/IT/SWE', '', '2018-04-02', '1960-01-01', '58', '', '5ac9215c147d1.pdf', 'a6620d61a959bb291050c315f82cbf66', 0, 'Student', 'Java, Android'),
(18, 'Test', 'User 1', 'test1@diu.edu.bd', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'gfghf', 'Rajshahi', 'Rajshahi', '0133534564', 'Graduate', 'Test', '2020-09-18', '1999-01-06', '21', 'hf', '5f6128c8e979e.pdf', '7a217274031ac544cf4e385b83de6f08', 1, 'fhgfh', 'fghfh'),
(19, 'Test', 'User 2', 'mdibrahimk48@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'gdfgdfg', 'Rajshahi', 'Rajshahi', '0173732892', 'Graduate', 'retdrfgfgh3252', '2020-09-17', '1999-01-29', '21', 'Graduate', '5f612a52d76ab.pdf', 'c8d8c6162d18ff0e393b7acd39afa330', 1, 'gfhfghjfg', 'dfgf'),
(2, 'Md', 'Shihab', 'shihab.user@gmail.com', 'OTU3MzljOGIyNGZjMGViN2FkNWIyMTQ3ZjAyOWFlY2Y=', 'Rajshahi', 'Chapai', 'Chapai', '1234567890', 'Bsc in CSE/IT/SWE', '', '2018-04-02', '1960-01-01', '58', '', '5ac920fc43d1b.pdf', '6971eb3debbeb7631ec729326122ceea', 1, 'Student', 'Java, Android'),
(3, 'Md', 'Shamim', 'shamim.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'Rajshahi', 'Chapai', 'Chapai', '1234567890', 'Bsc in CSE/IT/SWE', '', '2018-04-02', '1960-01-01', '58', '', '5ac9213e843e1.pdf', 'c1ffbc969a2a3ec8ea10c5e3091834ca', 0, 'Student', 'Java, Android'),
(4, 'Md', 'Noor', 'noor.user@gmail.com', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'Rajshahi', 'Chapai', 'Chapai', '1234567890', 'Bsc in CSE/IT/SWE', '', '2018-04-02', '1960-01-01', '58', '', '5ac9215c147d1.pdf', 'a6620d61a959bb291050c315f82cbf66', 0, 'Student', 'Java, Android'),
(18, 'Test', 'User 1', 'test1@diu.edu.bd', 'ZTM4OGYwMmY3NTBlNjVlYmJhOTVhYjk0OTNjZGEwMWU=', 'gfghf', 'Rajshahi', 'Rajshahi', '0133534564', 'Graduate', 'Test', '2020-09-18', '1999-01-06', '21', 'hf', '5f6128c8e979e.pdf', '7a217274031ac544cf4e385b83de6f08', 1, 'fhgfh', 'fghfh'),
...
--
-- Indexes for table `apply_internship_post`
--
ALTER TABLE `apply_internship_post`
...
--
-- Indexes for table `internship_post`
--
ALTER TABLE `internship_post`
  ADD PRIMARY KEY (`id_internshippost`);
